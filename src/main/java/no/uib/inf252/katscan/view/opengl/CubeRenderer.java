...
//
//            gl4.glGenTextures(VolumeRenderer.BUFFER.TEXTURE_LENGTH, buffers);
//            buffers.position(VolumeRenderer.BUFFER.TOTAL_LENGTH);
//            gl4.glActiveTexture(GL4.GL_TEXTURE0);
//            gl4.glBindTexture(GL4.GL_TEXTURE_3D, buffers.get(VolumeRenderer.BUFFER.TEXTURE));
